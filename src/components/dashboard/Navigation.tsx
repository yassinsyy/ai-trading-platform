...
export function Navigation({ activeSection, onSectionChange }: NavigationProps) {
  ...
  return (
    <nav className="w-80 bg-dark-gray border-r border-light-gray border-opacity-20 h-full flex flex-col flex-shrink-0">
      {/* Логотип компании */}
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-base text-light-gray truncate">
                    {section.subtitle}
                  </div>
                </div>
              </div>
